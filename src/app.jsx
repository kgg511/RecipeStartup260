    ...
    return (
      ...
      <div className='body'>
        ...
        <Routes>
            ...
            />} exact />
            <Route path='/AllRecipes' element={<AllRecipes changeAuthstate={setAuthState}/>} exact />
            <Route path='/MyRecipes' element={<MyRecipes changeAuthstate={setAuthState}/>} exact />
            <Route path='/AddRecipe' element={<AddRecipe changeAuthstate={setAuthState}/>} exact />
